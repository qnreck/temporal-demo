...
import com.kms.temporaldemo.worker.WorkerStartOtherWF;
...
public class TemporalWorkerStartOtherWF {
  ...
  public static void main(String[] args) {
    ...
    worker.registerActivitiesImplementations(new WorkerStartOtherWF());
